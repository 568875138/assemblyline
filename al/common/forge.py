...
def get_site_specific_login():
    config = get_config()
    return _dynamic_import(config.auth.login_method)
...
def get_yara_importer():
    config = get_config()
    return _dynamic_import(config.system.yara_importer)


def get_yara_parser():
    config = get_config()
    return _dynamic_import(config.system.yara_parser)
